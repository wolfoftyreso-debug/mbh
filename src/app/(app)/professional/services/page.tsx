...
export default async function ServicesPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <PageHeader title="Service listings" description="Define what you offer, how you price it and how fast you deliver. Listings help customers compare and pre-fill your offers." />
